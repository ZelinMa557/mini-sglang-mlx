...
class BaseCacheManager(ABC):
    @abstractmethod
    def match_prefix(self, input_ids: mx.array) -> Tuple[BaseCacheHandle, mx.array]:
        """
        ...
        Args:
            input_ids (mx.array): The input ids to match. Shape: (seq_len,)
        Returns:
            handle (BaseCacheHandle): The handle to the matched prefix.
            indices (mx.array): The indices of the longest-matched prefix in the cache.
        """
    ...
    def insert_prefix(self, input_ids: mx.array, indices: mx.array) -> int:
        ...
        Args:
            input_ids (mx.array): The input ids to insert. Shape: (seq_len,)
            indices (mx.array): The indices to store the new prefix. Shape: (seq_len,)
    ...
    def evict(self, size: int) -> mx.array:
        ...
        Returns:
            mx.array: The indices evicted. Shape: (evict_size,)
        Raises:
