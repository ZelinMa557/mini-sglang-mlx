...
:class:`mlx_serve.models.dflash2.CandidateSelector`).  The walk is the
...
from mlx_serve.core import Batch, use_ctx
...
class Dflash2Engine(DflashEngine):
    ...
    def _propose_drafts(self, proposal_batch: Batch) -> mx.array:
        ...
        :meth:`mlx_serve.models.dflash2.Model.propose` runs the block
