...
NB_MODULE(_ext, m) {
  m.doc() = "Kernel library for mini-sglang-mlx";
  m.def("moe_sum_reduce", &mini_sglang_mlx::moe_sum_reduce, "y"_a, "scores"_a,
        nb::kw_only(), "stream"_a = nb::none(),
        nb::sig(
            "def moe_sum_reduce(y: array, scores: array, *, "
            "stream: Union[None, Stream, Device] = None) -> array"));
  m.def("moe_sum_reduce_with_reorder", &mini_sglang_mlx::moe_sum_reduce_with_reorder,
  ...
  m.def("store_kv_cache", &mini_sglang_mlx::store_kv_cache,
  ...
  m.def("fast_compare_key", &mini_sglang_mlx::fast_compare_key,
        "a"_a, "b"_a,
        nb::sig("def fast_compare_key(a: array, b: array) -> int"));
  m.def("paged_decode_attention", &mini_sglang_mlx::paged_decode_attention,
        ...
        nb::sig(
            ...
            "*, stream: Union[None, Stream, Device] = None) -> array"));
  m.def("paged_prefill_attention", &mini_sglang_mlx::paged_prefill_attention,
        ...
        nb::sig(
            ...
            "stream: Union[None, Stream, Device] = None) -> array"));
  m.def("gdn_state_inplace", &mini_sglang_mlx::gdn_state_inplace,
