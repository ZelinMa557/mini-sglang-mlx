...
def _run_scheduler(args_payload: dict, ack_queue: mp.Queue[str]) -> None:
    from .args import ServerArgs
    from mini_sglang_mlx.scheduler import Scheduler
...
def launch_server() -> None:
    ...
    def start_subprocess() -> None:
        ...
        from mini_sglang_mlx.tokenizer import tokenize_worker
        ...
        mp.Process(
            ...
            daemon=False,
            name="mini-sglang-mlx-scheduler",
        ).start()
        ...
        mp.Process(
            ...
            daemon=False,
            name="mini-sglang-mlx-detokenizer-0",
        ).start()
        for i in range(num_tokenizers):
            mp.Process(
                ...
                daemon=False,
                name=f"mini-sglang-mlx-tokenizer-{i}",
            ).start()
