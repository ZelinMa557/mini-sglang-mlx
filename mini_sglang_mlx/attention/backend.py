...
from mini_sglang_mlx_kernel import paged_decode_attention, paged_prefill_attention

if TYPE_CHECKING:
    from mini_sglang_mlx.core import Batch, Req
    from mini_sglang_mlx.kvcache import BaseKVCache
    from mini_sglang_mlx.models.config import ModelConfig
...
class AttnBackend:
    """Paged attention backend for Apple GPU using mini-sglang-mlx-kernel operators."""
    ...
    def forward(
        ...
        *,
        ...
        to :func:`mini_sglang_mlx_kernel.paged_prefill_attention` and are
