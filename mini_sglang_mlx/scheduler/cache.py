...
from mini_sglang_mlx.kvcache import BaseCacheHandle, create_cache_manager

if TYPE_CHECKING:
    from mini_sglang_mlx.kvcache.mamba_pool import MambaStatePool
    from mini_sglang_mlx.kvcache.radix_manager import (
        HybridCacheHandle,
...
class CacheManager:
    ...
    def free_and_cache_finished_req(
        ...
        if mamba_slot is not None:
            from mini_sglang_mlx.kvcache.radix_manager import HybridRadixCacheManager
...
class HybridCacheManager(CacheManager):
    ...
    def __init__(
        ...
        from mini_sglang_mlx.kvcache import create_hybrid_radix_cache_manager
