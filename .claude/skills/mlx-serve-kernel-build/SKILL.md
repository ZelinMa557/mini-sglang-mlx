---
name: mlx-serve-kernel-build
description: How to build, test and debug the mlx-serve-kernel C++/Metal extension for the mlx-serve LLM inference engine. Use this when the user asks about compiling kernels, running kernel tests, or debugging Metal shaders in the mlx-serve project.
---

# mlx-serve-kernel Build & Debug

## Quick Build

From the `mlx-serve-kernel/` directory:
...
4. Export in `mlx_serve_kernel/__init__.py`.
